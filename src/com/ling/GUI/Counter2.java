...
public class Counter2 extends JFrame implements ActionListener {
	private JTextArea showText = new JTextArea(6,5);
	public Counter2() {
		super("¼ÆËãÆ÷");
		...
		contentPane.add(BorderLayout.NORTH, showText);
		contentPane.add(BorderLayout.CENTER, btnpane1);
		contentPane.add(BorderLayout.SOUTH, btnpane2);
